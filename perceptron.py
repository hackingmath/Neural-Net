"""CHapter 1 of Deep Learning for Games - Lanham
Sept. 28, 2019"""
...
def train_weights(train,learning_rate,epochs):
    ...
    for epoch in range(epochs):
        ...
        print('>epoch=%d, learning_rate=%.3f, error=%.3f' % (epoch,
                  learning_rate,sum_error))
    return weights

train = [[1.5,2.5,0.0],[2.5,3.5,0.0],[1.0,11.0,1.0],[2.3,2.3,1.0],
         [3.6,3.6,1.0],[4.2,2.4,0.0],[2.4,5.4,0.0],[5.1,5.1,1.0],
         [4.3,1.3,0.0],[4.8,4.8,1.0]] #[[1.5,2.5,0.0],[2.5,3.5,0.0],[1.0,1.0,1.0],[2.3,2.3,1],
         #[3.6,3.6,1],[4.2,2.4,0],[2.4,5.4,0],[5.1,5.1,1],[4.3,1.3,0],
        #[4.8,4.8,1]]
